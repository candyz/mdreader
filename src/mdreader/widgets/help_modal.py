...
HELP_SECTIONS = [
    (
        ...
        [
            ...
            ("↓ / ↑", "逐行向上 / 向下垂直平滑捲動"),
            ("← / → / d / f", "向左 / 向右水平捲動 (關閉折行時使用)"),
            ("gg / Home", "快速回到文件最上方 (Jump to Top)"),
            ("G / End", "快速跳至文件最下方 (Jump to Bottom)"),
            (":123 / 123G / 50gg", "跳轉至指定行號 (Goto Line Number)"),
        ],
    ),
    (
        "📑 檢視、排版與大綱 (View & Outline)",
        [
            ("O", "章節大綱目錄 (TOC Outline，按 Enter 即時跳轉)"),
            ("w / Alt+Z", "切換自動折行 (Toggle Soft Line Wrap)"),
            ("L / Alt+L", "切換行號欄顯示 (Toggle Line Numbers, 程式碼/純文字)"),
            ("t", "切換色彩主題 (Cycle Theme, 10+ 款主題持久化記憶)"),
            ("- / =", "縮放閱讀版面寬度 (Adjust Reading Width)"),
        ],
    ),
    (
    ...
    (
        ...
        [
            ("o", "檔案選擇器 (File Picker, Ctrl+R 最近檔案, Ctrl+H 隱藏檔)"),
            ("Ctrl+O", "Midnight Commander 雙欄檔案總管 (MC Mode)"),
    ...
    (
        ...
        [
            ("v / F4", "開啟外部編輯器 ($EDITOR / vim) 編輯並即時熱重載"),
            ("e", "匯出文件 (獨立 Styled HTML / 純文字 / Markdown)"),
            ("Y / Ctrl+K", "提取並複製程式碼區塊 (Copy Code Block)"),
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container"):
            ...
            with VerticalScroll(id="help-scroll"):
                for sec_title, items in HELP_SECTIONS:
